function kimonoCallback(slmaHeight) {
    var slmaWave = slmaHeight.results['collection1'][0]['property1'];
    document.getElementById("slmaWave").innerHTML=slmaWave;
  }

  $.ajax({
    "url":"http://www.kimonolabs.com/api/2bc36icq?apikey=b4dfe17359a0df9443cebb37c8d91400&callback=kimonoCallback",
    "crossDomain":true,
    "dataType":"jsonp"
});
...
function thumbs(bweather) {
    //
  }

  $.ajax({
    "url":"http://169.233.200.61:8888/?beach=manresa",
    "crossDomain":true,
    "dataType":"jsonp"
});